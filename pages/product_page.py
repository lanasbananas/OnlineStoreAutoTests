...
ADD_TO_BASKET_MESSAGE = "has been added to your basket."
...
class ProductPage(BasePage):
    ...
    def should_be_correct_amount(self):
        ...
        assert product_price == basket_amount, f"Incorrect amount. Got: {basket_amount}, expected: {product_price}"
    ...
    def should_be_message_about_add_to_basket(self):
        ...
        assert product_name_from_message + message_add_to_basket == product_name + ADD_TO_BASKET_MESSAGE, \
            f"Incorrect message. Got: {product_name_from_message + message_add_to_basket}, expected: {product_name + ADD_TO_BASKET_MESSAGE}"
